    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light bg-light" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand d-inline-flex" href="{{ route('index') }}"><img
                        ...
                        class="text-1000 fs-3 fw-bold ms-2 text-gradient">Wassel</span></a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active fw-bold" aria-current="page" href="{{ route('myaccount.index') }}">
                                        My account
                                    </a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-3">
                            <h5 class="lh-lg fw-bold text-white">Wassel</h5>
                            <ul class="list-unstyled mb-md-4 mb-lg-0">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-3">
                            <h5 class="lh-lg fw-bold text-white">RESTAURANTS</h5>
                            <ul class="list-unstyled mb-md-4 mb-lg-0">
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="/restaurants">All

                                        Restaurants</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Complaints
                                      </a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Privacy
                                        Policy</a></li>
                            </ul>
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xxl-4">
                            ...
                            <div class="text-start my-3"> <a href="#!">
                                    <svg class="svg-inline--fa fa-instagram fa-w-14 fs-2 me-2" aria-hidden="true"
                                        ...
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#ffb30e">
                                        <path
                                    ...
                                    <svg class="svg-inline--fa fa-facebook fa-w-16 fs-2 mx-2" aria-hidden="true"
                                        ...
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#ffb30e">
                                        <path
                    ...
                    <div class="row flex-center pb-3">
                        <div class="col-md-6 order-0">
                            <p class="text-200 text-center text-md-start">All rights Reserved &copy;Wassel, 2022
                            </p>
                        </div>
