        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="{{ route('restaurantview.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Owner Dashboard</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('restaurantview.edit', Auth::user()->restaurant_id) }}" class="menu-link">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Restaurants</span>
            </li>
            <li class="menu-item">
              <a href="" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Restaurants Menu</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('addMeal.index') }}" class="menu-link">
                    <div data-i18n="Connections">View Menu</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('addMeal.edit', Auth::user()->restaurant_id ) }}" class="menu-link">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/categories" class="menu-link"  >
                    <div data-i18n="Basic">View All Category</div>
                  </a>
                </li>
              </ul>
            </li> --}}
