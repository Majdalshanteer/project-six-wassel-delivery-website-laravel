          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Restaurants Info</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/add_resturant" class="menu-link">
                    <div data-i18n="Account">Add Restaurants</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="/dashboardrestaurants" class="menu-link">
                    <div data-i18n="Connections">View All Restaurants</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="user info"> User Info</div>
              </a>
              <ul class="menu-sub">
